...
# input dir, output dir, taxa of reference, whether coding or not, pdis, whether trim poor column, trim how may column in a unit
my ($dir, $outdir, $query_taxa, $non_coding_aln, $pdis_trsd, $trim_gap, $trim_unit, $help);
